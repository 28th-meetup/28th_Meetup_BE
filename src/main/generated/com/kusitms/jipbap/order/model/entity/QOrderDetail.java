...
public class QOrderDetail extends EntityPathBase<OrderDetail> {
    ...
    private static final long serialVersionUID = -826278746L;
    ...
    public final com.kusitms.jipbap.food.model.entity.QFoodOption foodOption;
    ...
    public QOrderDetail(Class<? extends OrderDetail> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodOption = inits.isInitialized("foodOption") ? new com.kusitms.jipbap.food.model.entity.QFoodOption(forProperty("foodOption"), inits.get("foodOption")) : null;
